...
const  Header = ({placeholder})=> {
  ...
  return (
    ...
    bg-white shadow-md p-5 md:px-10">
      ...
      flex items-center h-10 cursor-pointer my-auto ">
        <Image 
      ...
      rounded-full py-2 md:shadow-sm">
        <input value={searchValue} onChange ={e=>setInputValue(e.target.value)}
      ...
      <div className="flex items-center space-x-4
       justify-end text-gray-500">
        <p className='hidden md:inline cursor-pointer'>Became a host</p>
        <GlobeAltIcon className='h-6 cursor-pointer'/>
         <div className='flex items-cente rounded-full space-x-2 border-2 p-2'>
      ...
      {searchValue && (
        <div className='flex flex-col col-span-3 mx-auto'>
          ...
          <div className='flex items-center border-b mb-4 '>
            ...
            <input 
             onChange={e=>setNumbOfGuests(e.target.value)}
             value={numbOfGuests} 
             type="number" 
             min={1}
